    ...
    render() {
        return (
            <div className="TournamentView-container">
                ...
                {this.state.tournamentStatus === 'future' ? <div className="PlayerList"><JoinTournamentForm/> <PlayerList tournamentPlayers={this.state.tournamentPlayers}/>  </div>: <ScoreList games={this.state.games} players={this.state.players}/>}
            </div>
        )
    }
}
