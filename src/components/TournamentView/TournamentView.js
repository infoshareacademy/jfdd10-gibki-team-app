    ...
    render() {
        return (
            <div className="TournamentView-container">
                ...
                {this.state.tournamentStatus === 'future' ? <div><JoinTournamentForm/> <PlayerList tournamentPlayers={this.state.tournamentPlayers} playerListHeader={"Players taking part"}/> </div> : <ScoreList games={this.state.games} players={this.state.players}/>}
            </div>
        )
    }
}
