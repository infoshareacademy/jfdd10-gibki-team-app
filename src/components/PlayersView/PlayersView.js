        ...
        <div className="playersView-top-row">
          ...
          <div className="playersView-container">
            ...
            <div className="playersView-img-container">
              <img className="playersView-avatar" src="./purple-avatar.png" alt=""/>
              <img className="playersView-avatar" src="./blue-avatar.png" alt=""/>
              <img className="playersView-avatar" src="./green-avatar.png" alt=""/>
              <img className="playersView-avatar" src="./yellow-avatar.png" alt=""/>
              <img className="playersView-avatar" src="./orange-avatar.png" alt=""/>
              <img className="playersView-avatar" src="./red-avatar.png" alt=""/>
            </div>
          </div>
        </header>
